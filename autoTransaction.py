...
def autoTransaction():		
	...
	tran = digitAskLoop(tran, "ID already exists. Please enter again: ", tranIDExists)
	seller_id = None
	buyer_id = None
	v_id = None
	...
	while(True):
		...
		seller_id = blankSpaceLoop(seller_id, "Not a valid SIN. Please enter again: ")
	...
	while(True):
		...
		if seller_id == buyer_id:
			print("Seller and buyer can not be the same person")
			continue
		buyer_id = blankSpaceLoop(buyer_id, "Not a valid SIN. Please enter again: ")
	...
	while(True):
		...
		v_id = isOwnerChecker(v_id, seller_id, "Seller does not own this vehicle. Please try again: ")
		break	
